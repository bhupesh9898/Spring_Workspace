		...
		<div class="form-group   p-3 mb-2 bg-info text-white">
			...
			<div class="container" style="width: 35%;">
				...
				<div class="text-center mt-4">
					...
					<input value="update" name="update" type="submit" id="btnUpdate" class="submit_button btn btn-primary">
					<input value="delete" name="delete" type="submit" id="btnDelete" class="submit_button btn btn-primary">
				</div>
