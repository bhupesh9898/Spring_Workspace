...
<body>
	<form:form action="productOps" method="post" modelAttribute="product">
		...
		<div class="form-group   p-3 mb-2 bg-info text-white">
			...
			<h1 class="display-3 text-warning text-center mb-4">${msg2}</h1>
			</br>
			<p>
			...
			<div class="container" style="width: 35%;">
				...
				<div class="text-center mt-4">
					<input value="Insert" name="insert" type="submit" id="btnInsert" class="submit_button btn btn-success mr-2">
					<input value="Update" name="update" type="submit" id="btnUpdate" class="submit_button btn btn-primary mr-2">
					<input value="Delete" name="delete" type="submit" id="btnDelete" class="submit_button btn btn-danger">
				</div>
