...
<body>
	<form:form action="insertProduct" method="post" modelAttribute="product">
		...
		<div class="form-group   p-3 mb-2 bg-info text-white">
			...
			<h1 class="display-3 text-warning text-center mb-4">Insert Page</h1>
			</br>
			<p>
			...
			<div class="container" style="width: 35%;">
				...
				<form:input type="text" class="form-control" id="productCost" placeholder="Enter Product Cost" path="productCost"></form:input>
				<form:errors path="productCost"></form:errors>
				<div class="text-center mt-4">
					<button id="btn-insert" type="submit" class=" btn btn-success mr-3"
						style="width: 10rem;">Insert</button>
