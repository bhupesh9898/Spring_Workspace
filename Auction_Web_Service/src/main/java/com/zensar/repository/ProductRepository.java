...
public interface ProductRepository extends JpaRepository<Product, Integer>{
	...
	public void updateProduct(@Param("productId")int productId,@Param("productName")String productName,@Param("productDetails")String productDetails,@Param("bidAmount")int bidAmount,@Param("closingDate")Timestamp closingDate,@Param("status")String status,@Param("productCategoryId")int productCategory);
