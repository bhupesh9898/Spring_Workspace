...
public class UserResource {
	...
	public CustomResponse login(@RequestBody User user) {
		...
		if (result == 200) {
			...
			// System.out.println("userService.getUserByEmail(user.getEmail())" + user2);
			User.session = user2;

			System.out.println("Indise Login..." + user2);
	...
	public CustomResponse logout() {
		...
		System.out.println("User details in logout...." + User.session);
		System.out.println("Inside Log out ......" + User.session);
