...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User user = new User();
		user.setFullName("Avina ");
		user.setEmail("abc@xyz.com");
		user.setMobileNo("9907710811");
		user.setPassword("12345678");
		user.setUserProfile("Bidder");

		userRepository.save(user);

		User user2 = new User();
		user2.setFullName("Bhupesh");
		user2.setEmail("abcdef@xyz.com");
		user2.setMobileNo("5557710811");
		user2.setPassword("12345678");
		user2.setUserProfile("Bidder");
		...
		product1.setProductName("MyArt");
		product1.setProductDetails("Good Painting");
		product1.setBidAmount(1500);
		product1.setUser(user);
		product1.setProductCategory(category1);

		Product product2 = new Product();
		product2.setProductName("MyArt 2");
		product2.setProductDetails("Good Painting 2");
		product2.setBidAmount(1505);
		...
		Bid bid1 = new Bid();
		bid1.setBidAmount(1002);
		bid1.setProduct(product2);
		bid1.setUser(user);

		bidRepository.save(bid1);

		Bid bid2 = new Bid();
		bid2.setBidAmount(2050);
		bid2.setProduct(product1);
		bid2.setUser(user2);

		bidRepository.save(bid2);

		Bid bid3 = new Bid();
		bid3.setBidAmount(1050);
		bid3.setProduct(product2);
		bid3.setUser(user);

		bidRepository.save(bid3);

		Bid bid4 = new Bid();
		bid4.setBidAmount(2100);
		bid4.setProduct(product1);
		bid4.setUser(user2);
