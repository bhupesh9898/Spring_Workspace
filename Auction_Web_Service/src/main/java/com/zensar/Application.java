...
public class Application implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * 
		 * String categories[]=
		 * {"Traditional","Western","Drawing","Graphic","Photography","Sculpture",
		 * "Other"}; for(String s:categories) { ProductCategory p=new ProductCategory();
		 * p.setProductCategoryName(s); categoryRepository.save(p); }
		 */
